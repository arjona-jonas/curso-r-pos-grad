...
Como demanda da universidade, haverá um processo avaliativo dos alunos. Os exercícios disponibilizados precisam ser entregues até a segunda feira da semana seguinte na respectiva atividade no Classroom. A resolução precisa ser escrita e enviada em um arquivo em código R (ou seja, em um arquivo salvo do editor de texto com o final ".R"). É importante colocar o nome e sobrenome no título do arquivo. Qualquer dúvida não hesitem em me comunicar ou comunicar o monitor Davi.

A avaliação dos alunos consistirá num misto entre presença nos encontros, interação e entrega das atividades. Apesar das atividades terem respostas corretas, erros e acertos não contarão pontos, e sim a entrega das atividads. Feedbacks sobre as resoluções poderão eventualmente serem escritos. Após o prazo da entrega, as soluções serão disponibilizadas no material didático ao lado das questões.
